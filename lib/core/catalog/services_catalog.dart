  ...
  static const categories = <CatalogCategory>[
    CatalogCategory(
      ...
      types: [
        ...
        CatalogType(
            id: 'water_heater', fr: 'Chauffe-eau', ar: 'صيانة سخان الماء'),
        ...
        CatalogType(
            id: 'sofa_cleaning',
            fr: 'Nettoyage canapes',
            ar: 'تنظيف الكنبات والمفروشات'),
        CatalogType(
            id: 'pest_control', fr: 'Desinsectisation', ar: 'مكافحة الحشرات'),
        CatalogType(id: 'gardener', fr: 'Jardinier', ar: 'بستاني'),
        CatalogType(id: 'pool', fr: 'Entretien piscines', ar: 'صيانة المسابح'),
        CatalogType(
            id: 'window_cleaning', fr: 'Nettoyage vitres', ar: 'تنظيف النوافذ'),
        ...
        CatalogType(
            ...
            ar: 'تركيب الأثاث'),
        CatalogType(
            id: 'roof_isolation', fr: 'Isolation toiture', ar: 'عزل الأسطح'),
        CatalogType(
            id: 'parabole', fr: 'Installation parabole', ar: 'تركيب parabole'),
        CatalogType(
            id: 'cctv', fr: 'Cameras surveillance', ar: 'تركيب كاميرات مراقبة'),
        CatalogType(
            id: 'doors', fr: 'Installation portes', ar: 'تركيب الأبواب'),
        CatalogType(
            id: 'windows', fr: 'Installation fenetres', ar: 'تركيب النوافذ'),
        CatalogType(
            id: 'plaster',
            fr: 'Platre / decoration',
            ar: 'تركيب الجبس والديكور'),
    ...
    CatalogCategory(
      ...
      types: [
        ...
        CatalogType(
            id: 'auto_electric', fr: 'Electricien auto', ar: 'كهربائي سيارات'),
        CatalogType(id: 'bodywork', fr: 'Tolier', ar: 'Tolier'),
        CatalogType(
            id: 'paint_auto',
            fr: 'Carrosserie & peinture',
            ar: 'سمكري ودهان سيارات'),
        CatalogType(id: 'tires', fr: 'Reparation pneus', ar: 'إصلاح الإطارات'),
        CatalogType(
            id: 'battery', fr: 'Remplacement batterie', ar: 'تبديل البطارية'),
        CatalogType(
            id: 'glass_auto', fr: 'Vitres / pare-brise', ar: 'إصلاح البلور'),
        CatalogType(
            id: 'lights', fr: 'Reparation eclairage', ar: 'إصلاح الأضواء'),
        CatalogType(
            id: 'locksmith_auto',
            fr: 'Serrurier automobile',
            ar: 'Serrurier Automobile'),
        CatalogType(
            id: 'ac_auto', fr: 'Climatisation auto', ar: 'صيانة Climatiseur'),
        ...
        CatalogType(
            id: 'diagnostic',
            fr: 'Diagnostic electronique',
            ar: 'Diagnostic إلكتروني'),
        CatalogType(
            id: 'towing',
            fr: 'Depannage / remorquage',
            ar: 'Dépannage (سحب السيارات)'),
      ],
    ),
    CatalogCategory(
      id: 'health',
      ...
      types: [
        ...
        CatalogType(
            id: 'specialist', fr: 'Medecin specialiste', ar: 'طبيب مختص'),
        ...
        CatalogType(
            id: 'pharmacy', fr: 'Livraison pharmacie', ar: 'صيدلية توصيل'),
      ],
    ),
    CatalogCategory(
      id: 'beauty',
    ...
    CatalogCategory(
      ...
      types: [
        CatalogType(
            id: 'tutor', fr: 'Professeur particulier', ar: 'مدرس خصوصي'),
        CatalogType(
            id: 'languages', fr: 'Professeur de langues', ar: 'مدرس لغات'),
        CatalogType(
            id: 'it', fr: 'Professeur informatique', ar: 'مدرس إعلامية'),
    ...
    CatalogCategory(
      ...
      types: [
        ...
        CatalogType(
            id: 'graphic', fr: 'Graphic Designer', ar: 'Graphic Designer'),
        ...
        CatalogType(
            id: 'marketing', fr: 'Digital marketing', ar: 'Digital Marketing'),
    ...
    CatalogCategory(
      ...
      types: [
        ...
        CatalogType(
            id: 'trainer', fr: 'Education animaux', ar: 'تدريب الحيوانات'),
      ],
    ),
    CatalogCategory(
      id: 'events',
      ...
      types: [
        CatalogType(
            id: 'wedding_photo', fr: 'Photographe mariage', ar: 'مصور أعراس'),
    ...
    CatalogCategory(
      ...
      types: [
        CatalogType(id: 'moving', fr: 'Demenagement', ar: 'نقل الأثاث'),
        CatalogType(
            id: 'goods', fr: 'Transport marchandises', ar: 'نقل البضائع'),
    ...
    CatalogCategory(
      ...
      types: [
        ...
        CatalogType(
            id: 'real_estate', fr: 'Agent immobilier', ar: 'وكيل عقاري'),
        CatalogType(
            id: 'legal', fr: 'Conseiller juridique', ar: 'مستشار قانوني'),
    ...
    CatalogCategory(
      ...
      types: [
        CatalogType(
            id: 'laundry', fr: 'Lavage & repassage', ar: 'غسيل وكي الملابس'),
        CatalogType(id: 'tailor', fr: 'Tailleur', ar: 'خياط'),
        CatalogType(
            id: 'watch_repair', fr: 'Reparation montres', ar: 'إصلاح الساعات'),
        CatalogType(
            id: 'phone_repair',
            fr: 'Reparation telephones',
            ar: 'إصلاح الهواتف'),
        CatalogType(id: 'tv_repair', fr: 'Reparation TV', ar: 'إصلاح التلفاز'),
        CatalogType(
            id: 'fridge_repair',
            fr: 'Reparation refrigerateurs',
            ar: 'إصلاح الثلاجات'),
        CatalogType(
            id: 'washer_repair',
            fr: 'Reparation machines a laver',
            ar: 'إصلاح الغسالات'),
        CatalogType(
            id: 'oven_repair', fr: 'Reparation fours', ar: 'إصلاح الأفران'),
        CatalogType(
            id: 'coffee_repair',
            fr: 'Reparation machines a cafe',
            ar: 'إصلاح آلات القهوة'),
      ],
    ),
  ];
